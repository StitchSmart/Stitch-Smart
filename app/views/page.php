...
.page2 a {
    color: var(--page-link, #c19a4e) !important;
}
.page2 a:hover {
...
.page2 .contact-section {
    ...
    color: var(--page-text, #f4e9d3) !important;
    border-color: var(--page-border, rgba(193,154,78,0.2)) !important;
}
.page2 .card h1,
.page2 .card h2,
.page2 .card h3,
...
.help-header { background-color: var(--bg-card, #0a0a0a); padding: 60px 15px 30px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.2); margin-bottom: 40px; } .help-header h1 { font-weight: 600; margin-bottom: 15px; } .faq-card { margin-bottom: 15px; border-radius: 8px; border: 1px solid rgba(193,154,78,0.2); transition: transform 0.2s; background: var(--bg-card, #0a0a0a); } .faq-card:hover { transform: translateY(-2px); box-shadow: 0 4px 15px rgba(193,154,78,0.1); } .contact-section { background-color: var(--bg-card, #0a0a0a); padding: 40px 20px; border-radius: 8px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.2); margin-top: 40px; border: 1px solid rgba(193,154,78,0.2); } .contact-section h4 { margin-bottom: 15px; font-weight: 500; } .contact-section p { font-size: 1.1rem; margin-bottom: 0; } 
</style>
</head>
<body>
...
<h1 class="text-center mb-4"><?= htmlspecialchars($page['title']); ?></h1>
</div>
