...
<head>
    ...
    <style>
        ...
        .card { border-radius: 16px; box-shadow: 0 6px 20px rgba(0,0,0,0.12); }
        ...
        .color-circle.selected { border: 3px solid #007bff; transform: scale(1.15); }
        .image-preview, .dynamic-image {
            max-width: 100%; height: auto; border-radius: 12px; border: 1px solid #e0e0e0;
        }
        .size-chart table { width: 100%; border-collapse: collapse; font-size: 0.95rem; }
        .size-chart th, .size-chart td { border: 1px solid #dee2e6; padding: 10px; text-align: center; }
        .size-chart th { background-color: #e9ecef; font-weight: 600; }
        .info-card {
...
`;
            ...
            const mailtoLink = `mailto:stitchSmartofficial@gmail.com?subject=New Shorts Order - ${name}&body=${encodeURIComponent(emailBody)}`;
