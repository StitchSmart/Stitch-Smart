...
<head>
    ...
    <title>Custom Sweatpants Order Form</title>
...
<body>
    <div class="container my-5">
            <h1 class="text-center mb-4 fw-bold">Custom Sweatpants Order Form</h1>
        <div id="progress" class="progress mb-5 shadow-sm">
            <div class="progress-bar bg-primary" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
        </div>

        <!-- Step 1: Fit, Fabric & Color -->
        <div id="step1" class="step card p-4 active shadow">
            <h2 class="text-center mb-4">Step 1: Choose Fit, Fabric & Color</h2>
            <div class="row g-4">
                <div class="col-md-4">
                    <h5>Choose your fit</h5>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="fit" id="straightLeg" value="Straight Leg" checked onchange="updateSizeChart()">
                        <label class="form-check-label" for="straightLeg">Straight Leg</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="fit" id="baggyFit" value="Baggy Fit" onchange="updateSizeChart()">
                        <label class="form-check-label" for="baggyFit">Baggy Fit</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <h5>Choose Fabric</h5>
                    <select class="form-select" id="fabric">
                        ...
                        <option value="Heavy Fleece, 400GSM, 100% cotton">Heavy Fleece, 400GSM, 100% cotton</option>
                        <option value="Fleece, 320-350GSM, brushed back">Fleece, 320-350GSM, brushed back</option>
                        <option value="French Terry, 350GSM, 100% cotton">French Terry, 350GSM, 100% cotton</option>
                        <option value="Premium French Terry, 400GSM">Premium French Terry, 400GSM</option>
            ...
            <div class="mt-4">
                <h5>Additional Notes (waistband, drawcord, cuffs, etc.)</h5>
                <textarea class="form-control" id="additionalNotes" rows="3"></textarea>
            </div>

            <div class="mt-4 size-chart">
                <h5>Size Chart (cm)</h5>
                <img id="sizeChartImg" src="<?= BASE_URL ?>/pictures/design/pants_1_measures.png" alt="Size Chart" class="dynamic-image mb-3">
            ...
            <div class="text-end mt-5">
                <button class="btn btn-primary px-5 py-3" onclick="nextStep(1)">Next →</button>
            </div>
        </div>

        <!-- Step 2: Labels (with default material selected) -->
        <div id="step2" class="step card p-4 shadow">
            ...
            <div class="text-end mt-5">
                ...
                <button class="btn btn-primary px-5" onclick="nextStep(2)">Next</button>
            </div>
        </div>
        ...
        <div id="step3" class="step card p-4 shadow">
            ...
            <p class="text-center text-muted mb-4">
                Describe your desired prints, embroidery, distressing placement, drawcord color, cuff style, etc.
            </p>

            <textarea class="form-control" id="establishmentComments" rows="7" placeholder="Examples:
• Left thigh small logo print 10×10 cm white
• Right leg full distressing + ripped effect
• Back pocket embroidery (small logo)
• Drawcord color: contrast white
• Cuff: ribbed tight or loose open hem..."></textarea>

            <div class="text-end mt-5">
                <button class="btn btn-secondary me-3 px-4" onclick="prevStep(3)">Previous</button>
                <button class="btn btn-primary px-5" onclick="nextStep(3)">Next</button>
            </div>
        </div>
        ...
        <div id="step4" class="step card p-5 shadow">
            ...
            <div class="info-card">
                ...
                <p>
                    We believe in creating sweatpants that are not just comfortable but also stylish and durable.<br>
                    Our sweatpants are made from premium-quality fabrics that ensure breathability and long-lasting wear.<br>
                    With customizable options like distressing, prints, labels, and fit — you can create a unique pair that perfectly reflects your style.
                </p>
                ...
                <img src="<?= BASE_URL ?>/pictures/design/pants_2_measures.png" alt="Premium Sweatpants" class="preview-img">
            </div>

            <p class="text-center text-muted mt-4 fs-5">
                All customization requests (prints, distressing, pockets, drawcord color, cuff style, etc.)<br>
            ...
            <div class="text-end mt-5">
                ...
                <button class="btn btn-primary px-5 py-3" onclick="nextStep(4)">Next →</button>
            </div>
        </div>
        ...
        <div id="step5" class="step card p-4 shadow">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-3 quantity-row">
                        <div class="col-6 col-sm-4"><label>XXS</label><input type="number" min="0" class="form-control" id="qtyXXS"></div>
                        ...
                        <div class="col-6 col-sm-4"><label>XXXL</label><input type="number" min="0" class="form-control" id="qtyXXXL"></div>
                        <div class="col-6 col-sm-4"><label>XXXXL</label><input type="number" min="0" class="form-control" id="qtyXXXXL"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-end mt-5">
                ...
                <button class="btn btn-primary px-5 py-3" onclick="nextStep(5)">Next →</button>
            </div>
        </div>
        ...
        <div id="step6" class="step card p-4 shadow">
            ...
            <div class="text-end mt-5">
                ...
                <button type="button" class="btn btn-primary px-5 py-3" onclick="sendInquiry()">Send Inquiry →</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const sizeCharts = {
            'Straight Leg': [
                { label: 'Waist (relaxed)', values: ['34','36','38','40','42','44','46'] },
                { label: 'Waist (stretched)', values: ['44','46','48','50','52','54','56'] },
                { label: 'Hip', values: ['52','54','56','58','60','62','64'] },
                { label: 'Thigh', values: ['30','31','32','33','34','35','36'] },
                { label: 'Inseam', values: ['76','78','80','82','84','86','88'] },
                { label: 'Outseam', values: ['100','102','104','106','108','110','112'] }
            ],
            'Baggy Fit': [
                { label: 'Waist (relaxed)', values: ['36','38','40','42','44','46','48'] },
                { label: 'Waist (stretched)', values: ['48','50','52','54','56','58','60'] },
                { label: 'Hip', values: ['58','60','62','64','66','68','70'] },
                { label: 'Thigh', values: ['34','35','36','37','38','39','40'] },
                { label: 'Inseam', values: ['74','76','78','80','82','84','86'] },
                { label: 'Outseam', values: ['102','104','106','108','110','112','114'] }
            ]
        };
        ...
        function updateLabelPreview() {
            ...
            if (selected === 'none') {
                src = '<?= BASE_URL ?>/pictures/design/empty_pants.png';
        ...
        function previewImage(inputId, previewId) {
            ...
            if (file) {
                ...
                if(previewId === 'labelPreview') {
                    ...
                    document.getElementById(previewId).src = '<?= BASE_URL ?>/pictures/design/empty_pants.png';
                }
            }
        }
        ...
        function sendInquiry() {
            ...
            let emailBody = `New Sweatpants Custom Order from ${name}
----------------------------------------
...
Sent from Sweatpants Custom Form
`;

            const mailtoLink = `mailto:stitchSmartofficial@gmail.com?subject=New Sweatpants Order - ${name}&body=${encodeURIComponent(emailBody)}`;
