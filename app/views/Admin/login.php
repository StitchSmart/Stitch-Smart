...
<head>
    ...
    <style>
        :root {
            ...
            --default-grad: linear-gradient(135deg, #3d241c 0%, #c19a4e 100%);
            --accent-bronze: #CD9A48;
            --accent-brown: #3d241c;
        }
        ...
        .decor-circle {
            ...
            height: 300px;
            border-radius: 50%;
            background: <?= ($theme === 'theme-luxury') ? 'rgba(61, 36, 28, 0.05)' : 'rgba(193, 154, 78, 0.05)' ?>;
            z-index: 1;
        }
    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            ...
            <div class="login-content">
                ...
                <?php if(isset($_SESSION['login_error'])): ?>
                    <div class="alert alert-danger p-2 text-center" style="font-size: 0.9rem; background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.2); color: #ef4444; border-radius: 12px; margin-bottom: 20px;"><?= $_SESSION['login_error']; unset($_SESSION['login_error']); ?></div>
                <?php endif; ?>
                ...
                <form action="<?php echo BASE_URL; ?>index.php?page=admin_login" method="POST">
                    ...
                    <div class="extra-links">
                        ...
                        <a href="<?php echo BASE_URL; ?>index.php?page=admin_forgot_password">Forgot Password?</a>
                    </div>
        ...
        <div class="login-right">
            ...
            <div class="illustration-container">
                ...
                <h5 class="fw-bold mb-3" style="color: #3d241c; letter-spacing: 1px;">PREMIUM ERP SYSTEM</h5>
