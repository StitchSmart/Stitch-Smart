...
<body>
    ...
    <div class="recovery-card">
        ...
        <?php if ($step === 'request'): ?>
            ...
            <form method="POST" action="<?= BASE_URL ?>index.php?page=admin_forgot_password">
            ...
            <a href="<?= BASE_URL ?>index.php?page=admin_login" class="back-link">
        ...
        <?php elseif ($step === 'verify_otp'): ?>
            ...
            <a href="<?= BASE_URL ?>index.php?page=admin_forgot_password&action=cancel" class="back-link" style="color: #ccc;">
                Cancel & Start Over
            </a>
