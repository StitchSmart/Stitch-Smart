    ...
    public function store()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($errors)) {
                ...
                header("Location: " . BASE_URL . "/index.php?page=add_category");
                exit;
            }
            ...
            */
            ...
            header("Location: " . BASE_URL . "/index.php?page=admin_categories");
            exit;
        }
    }
    ...
    public function update()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($errors)) {
                ...
                header("Location: " . BASE_URL . "/index.php?page=edit_category&id=" . $id);
                exit;
            }
